...
async function initializeSystemTabs() {
  try {
    console.log('🔗 Connecting to MongoDB...');
    await mongoose.connect(MONGODB_URI);
    console.log('✅ Connected to MongoDB');

    console.log('🗂️ Initializing system tabs...');
    ...
    console.log('🎉 System tabs initialization completed!');
    ...
    console.error('❌ Error initializing system tabs:', error);
  } finally {

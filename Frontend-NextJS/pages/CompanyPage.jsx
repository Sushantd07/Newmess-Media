...
const CompanyPage = () => {
    ...
    try {
      ...
      if (updatedData.complaintContent && updatedData.complaintContent.trim() !== '') {
        ...
        try {
          ...
          console.log('🌐 API Endpoint:', `${import.meta.env.VITE_API_BASE_URL || '/api'}/structured-complaints/company/${companySlug}`);
          console.log('📊 Database Collection: structuredComplaints');
          
          // Save to structuredComplaints collection
          const response = await fetch(`${import.meta.env.VITE_API_BASE_URL || '/api'}/structured-complaints/company/${companySlug}`, {
            method: 'POST',
      ...
      const response = await fetch(`${import.meta.env.VITE_API_BASE_URL || '/api'}/subcategories/company-page/${unifiedData._id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleCanvaSave = async (updatedContactData) => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_BASE_URL || '/api'}/subcategories/company-page/${unifiedData._id}/contact-numbers`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleSaveComplaintsData = async (updatedComplaintsData) => {
    try {
      ...
      console.log('🌐 API URL:', `${import.meta.env.VITE_API_BASE_URL || '/api'}/structured-complaints/company/${companySlug}`);
  ...
  const handleSaveStructuredComplaintsData = async (structuredData) => {
    ...
    try {
      ...
      console.log('🌐 Making API call to:', `${import.meta.env.VITE_API_BASE_URL || '/api'}/structured-complaints/company/${companySlug}`);

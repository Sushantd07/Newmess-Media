...
const SimpleTabManager = ({ companyData, onSave }) => {
  ...
  const handleAddTab = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:3000/api/tabs/${apiEndpoint}`, {
        method: 'POST',
        headers: {
      ...
      const linkResponse = await fetch(`http://localhost:3000/api/subcategories/${companyData._id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleSaveTabEdit = async () => {
    ...
    try {
      ...
      if (editingTab.tabId) {
        const response = await fetch(`http://localhost:3000/api/tabs/${apiEndpoint}/${editingTab.tabId}`, {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
          },
  ...
  const updateCompanyTabs = async (updatedTabs) => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:3000/api/subcategories/${companyData._id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          onClick={async () => {
            ...
            try {
              const response = await fetch('http://localhost:3000/api/tabs/complaints', {
                method: 'POST',

      ...
      <div className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center">
            <div className="inline-flex items-center bg-orange-500 text-white px-3 py-1.5 sm:px-4 sm:py-2 rounded-full text-xs sm:text-sm font-medium mb-4 sm:mb-6">
              Business Categories
            </div>
            <h1 className="text-xl sm:text-3xl md:text-4xl font-bold mb-2 sm:mb-3 leading-tight">
              Find <span className="text-orange-500">Verified Numbers</span> by Category
            </h1>
            <p className="text-xs sm:text-base text-gray-300 mb-4 sm:mb-8 max-w-3xl mx-auto">
            ...
            <form onSubmit={handleSearch} className="max-w-2xl mx-auto">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 sm:pl-14 pr-24 sm:pr-28 py-2.5 sm:py-3 text-sm sm:text-lg bg-white border-0 rounded-full focus:ring-4 focus:ring-orange-500/20 focus:outline-none text-gray-900"
                />
                <button
                  type="submit"
                  className="absolute right-2 top-1.5 bottom-1.5 sm:top-2 sm:bottom-2 px-4 sm:px-5 bg-orange-500 text-white rounded-full hover:bg-orange-600 transition-colors font-medium text-xs sm:text-base"
                >
                  Search
                </button>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col gap-4 mb-8">
          <div className="flex items-start sm:items-center justify-between gap-3">
            <div>
              <h2 className="text-xl sm:text-3xl font-bold text-gray-900 mb-1">All Business Categories</h2>
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-3 py-2 border border-gray-300 rounded-lg bg-white hover:bg-gray-50 text-xs sm:text-sm"
              title="Toggle view"
            >
            ...
            {sortedCategories.map((category) => {
              ...
              return (
                <button
                  ...
                  className="flex flex-col items-center justify-center p-1.5 bg-transparent hover:opacity-80 active:opacity-70 transition"
                >
                  <div className="w-9 h-9 rounded-full flex items-center justify-center bg-white border border-gray-200 mb-1">
                    {hasCustomIcon ? (
                      <div className="h-5 w-5 text-gray-700" dangerouslySetInnerHTML={{ __html: category.icon }} />
                    ) : isImageFile ? (
                      <img src={category.icon} alt={`${category.name} icon`} className="h-5 w-5 object-contain" />
                    ) : (
                      <Icon className="h-5 w-5 text-gray-700" />
                    )}
                  </div>
                  <span className="text-[10px] font-semibold text-gray-800 text-center leading-tight line-clamp-2">
                    {category.name}
                  </span>
                </button>
              );
